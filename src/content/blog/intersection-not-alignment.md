...
|---|---|---|
| Gauge envelope | [Spin(10) downstream-breaking note](/papers/29-spin10-downstream-breaking-family/) + this paper | $P_{\rm pol}^{D_5}$ (sharpened from $P_{SO(10)}^{\rm br}$) + $P_{\rm fam}$ |
