...
它是唯一一种我们至今没有量子理论的力。它不属于标准模型。它的强度比电磁力弱大约 40 个数量级 — 这就是著名的 *等级问题* — 而至今没有公认的解释。引力还编码了宇宙学常数 $\Lambda$,后者比朴素量子场论预期的值小约 120 个数量级 — *宇宙学常数问题* — 同样没有公认的解释。

这两个问题通常被视为基础物理学最深的未解问题。它们也通常被当作两个独立的问题来处理:超对称、额外维度等研究计划处理等级问题;暗能量、人择多重宇宙等研究计划处理宇宙学常数问题。
