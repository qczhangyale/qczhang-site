...
description: "质子-电子质量比几乎正好等于 $6\\pi^5$。Friedrich Lenz 在 1951 年注意到这一点;75 年来,没有人解释过它。一篇新论文表明这个公式有一个归宿——不是作为 TCG 旗的延伸,而是作为 Pati–Salam 表示-体积不变量。朴素的几何解读失败了;一个表示论的解读起作用了。Lenz 系数是 $\\mathbb{P}(\\wedge^2\\mathbf{4})$ 的腔室加权体积——反对称色-轻子态的射影空间。这不是一个推导,但它给了公式在该计划内一个清晰的住址。"
pubDate: 2026-05-08
---

质子大约比电子重 1836 倍。精确的比率,测量到 12 位有效数字,是
...
1951 年,德国物理学家 Friedrich Lenz 在给《Physical Review》的一封两句话的信中指出了这一点。他写了一个等式、两句话、一个引用,然后停下来。他没有理论;他只是做了观察。75 年后,没有人解释过它。标准模型把 $m_p/m_e$ 当作输入;格点 QCD 以亚百分位精度数值地计算质子质量,但不推导*为什么*这个比率如此接近 $\pi$ 的一个闭合表达式。
