...
然而,当你看物理学中三个最深的未解之谜 — 牛顿引力常数 $G$、宇宙学常数 $\Lambda$、重子-光子比 $\eta$,这三个量横跨引力、暗能量、早期宇宙这些彼此遥远的部门 — 你会发现一种奇怪的规律。三者都可以约化为同*两个*数的组合,而这两个数都属于电子。具体地说,精细结构常数 $\alpha \approx 1/137$(它控制电子如何与光子相互作用)和电子 Yukawa 耦合 $y_e \approx 3 \times 10^{-6}$(它控制电子如何与希格斯场相互作用)。
