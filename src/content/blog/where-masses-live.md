...
The paper, *Bulk–Boundary Localization in Twistor Configuration Geometry: A Conjecture for the Coupling/Mass Sector Split*, is on Zenodo (DOI [10.5281/zenodo.20097223](https://doi.org/10.5281/zenodo.20097223); CC-BY-4.0). It is short — ten pages, fourteen references, two theorems, one conjecture, five failure modes. It does not close the framework's hardest gap. It converts the gap from an arbitrary assignment into a localization principle with concrete falsification paths. That is the kind of progress the program owes itself, and the kind that future structural work can take seriously.
