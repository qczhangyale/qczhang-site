...
[緊接其後的下游論文](/zh-tw/papers/29-spin10-downstream-breaking-family/)將剩餘開放內容分裂為兩個位於活躍 TCG/FPA 框架清單之外的殘餘標籤:$P_{SO(10)}^{\rm br}$(破缺真空 + 弱邊界不對稱性)和 $P_{\rm fam}$(世代三化)。破缺殘餘提出動力學問題:一旦 $SU(2)_R$ 在代數層面被提供,什麼機制在低能下實際破缺它並產生觀測到的規範群?
...
| 弧 | 閉合短文 | 命名殘餘(不在活躍清單) |
|---|---|---|
| 規範包絡 | [Spin(10) 下游破缺短文](/zh-tw/papers/29-spin10-downstream-breaking-family/) + 本論文 | $P_{\rm pol}^{D_5}$(由 $P_{SO(10)}^{\rm br}$ 銳化)+ $P_{\rm fam}$ |
