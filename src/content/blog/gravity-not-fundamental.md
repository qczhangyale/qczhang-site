...
In 1798 the English natural philosopher Henry Cavendish weighed the Earth. He used a torsion balance — two small lead balls suspended on a thin wire, with two larger lead spheres set nearby — and measured how much the smaller balls swung toward the larger ones. From the deflection he extracted Newton's gravitational constant $G$, and from $G$ he calculated the mass of the planet. The experiment took months of fastidious shielding against drafts and temperature fluctuations. The signal he was measuring was tiny.

It is still tiny. Two and a quarter centuries later, $G$ is the worst-measured fundamental constant in physics by several orders of magnitude. Different precision experiments give answers that disagree at the part-per-thousand level — a level of disagreement that would be considered scandalous for the fine-structure constant, which is known to twelve significant figures. The reason is the same one that gave Cavendish trouble: gravity, between any two laboratory-scale objects, is fantastically weak.

Compare it to electromagnetism. The electric force between two electrons exceeds their gravitational attraction by a factor of about $10^{43}$. Forty-three orders of magnitude. This staggering difference is one of the deepest puzzles in physics — known as the *hierarchy problem* — and there is no accepted explanation for why nature would choose such a wildly mismatched set of forces. A second, related problem: the cosmological constant, the energy density of empty space, sits about 120 orders of magnitude below the value naive quantum field theory predicts. This is the *cosmological-constant problem*. Both involve gravity. Both are usually treated as separate puzzles, attacked by separate research programs: supersymmetry and extra dimensions for the hierarchy problem; quintessence, dark energy, anthropic landscapes for the cosmological constant.
